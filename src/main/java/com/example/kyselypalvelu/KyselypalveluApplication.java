...
public class KyselypalveluApplication {
	...
	@Bean
	public CommandLineRunner initialQuestionsAndQuestionnaires(QuestionRepository questions,
			QuestionnaireRepository questionnaires, OptionsRepository optionsRepo,
		...
		return (args) -> {
			...
			Questionnaire questionnaire2 = new Questionnaire("Kyselylomakkeen arviointi",
					"Anna palautetta kyselylomakkeesta");
			...
			Options options1 = optionsRepo
					.save(new Options(new ArrayList<>(Arrays.asList("Kyllä", "Neutraali", "Ei"))));
			...
			questionList
					.add(new Question("Mikä oli sinusta merkittävintä mitä opit kurssin aikana?", questionnaire, text));
			...
			questionList.add(new Question("Minkä arvosanan antaisit kurssin oppimateriaaleille? (1-5)", questionnaire,
					radio, options));
			questionList.add(new Question("Minkä arvosanan annat kokonaisuudessaan kurssille? (1-5)", questionnaire,
					radio, options));
			...
			questionList2.add(
					new Question("Mitä mieltä olet kyselylomakkeen visuaalisesta ilmeestä?", questionnaire2, text));
			...
			questionList2.add(
					new Question("Minkä arvosanan antaisit kyselylomakkeelle? (1-5)", questionnaire2, radio, options));
